...
- Evaluación e implementación de páginas en **WeWeb** como alternativa low-code para la web
- Páginas para **edición online de contratos** y validación de afirmaciones con un endpoint basado en IA y “fuente de verdad”
- **Azure Function (TimerTrigger)** que procesa CSVs en cloud storage y actualiza contactos en **HubSpot** (llegó a producción)

Trabajo en inglés con Slack/videollamadas/tickets, metodología Agile, Jira y Git.
